...
#define SPLINTER_BITS 4
#define BLOCK_SIZE_BITS 28
#define REQUEST_SIZE_BITS 14 // max allocation is 16384
#define UNUSED_SIZE_BITS 10
...
// padding size, splinter, unused, blocksize, alloc
...
struct __attribute__((__packed__)) sf_header {
    ...
    uint64_t unused_bits : UNUSED_SIZE_BITS;        // Subtract 4        
    uint64_t padding_size : PADDING_SIZE_BITS;      // Add 4 to this    account for splintering (31 bytes)
                                                        // 6 bits 
                                                    //0 0 0 0
                                                       8  4  2 1
};
